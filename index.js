"use strict";
var express = require("express"), http = require("http"), path = require("path"), bodyParser = require("body-parser");
...
app.post("/redetail", function(req, res){
	...
	if(stat == 1){
		if(review == 1){
			...
			var sql2 = "select * from users where position = 1";
